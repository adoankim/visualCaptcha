...
class Captcha {
	...
	private $configurationClass = 'inc/configuration.class.php';
	private $internationalizationClass = 'inc/internationalization.class.php';
	...
	public function __construct($formId = NULL, $type = NULL, $fieldName = NULL, $accessibilityFieldName = NULL) {
		...
		require_once($this->internationalizationClass);
		require_once($this->configurationClass);
    $internationalization = Internationalization::getInstance();
    self::$imagesPath = Configuration::getImagesPath();
    self::$audiosPath = Configuration::getAudiosPath();
		...
		// Setup Images and accesibility options in languages PHP files at lang dir.
		$this->answers = $internationalization->getAnswers();
    $this->accessibilityOptions = $internationalization->getAccessibilityOptions();
	}
